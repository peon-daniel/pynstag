...
This utility is meant to pad all the jpeg files in the current directory to make them 4:5 with resolution 1080px by 1350, because this is the maximum allowed on instagram athe moment.
